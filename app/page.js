...
const page = () => {
  return (
      <div className='overflow-auto lg:overflow-auto h-dvh lg:h-dvh w-dvw bg-black flex flex-col items-center xl:flex-row gap-5 lg:gap-0'>
          ...
          <div className='xl:flex-1 flex flex-col items-center h-auto justify-center xl:justify-between px-10 xl:px-5 xl:pt-16 gap-5'>
              <p className='font-medium text-center w-full text-white drop-shadow-[0_0_5px_rgba(255,255,255,1)]'>Vote now for the Best Dressed and help us crown the ultimate retro vintage style icon!</p>
              <div className='relative h-[598px] w-[560px] hidden xl:flex flex-col items-center justify-start'>
                ...
                <input placeholder='Enter Vote ID' className='text-white absolute top-[35%] bg-[#242424] p-2 rounded-lg border-2 w-3/6 mt-[] border-white z-10'/>
                <input placeholder='Enter Candidate Name' className='text-white absolute top-[45%] bg-[#242424] p-2 rounded-lg border-2 w-3/6 mt-[] border-white z-10'/>
                <button className='absolute top-[55%] text-white  bg-[#242424] px-1 rounded-lg border-2 w-[20%] mt-[] border-white z-10'>Submit !</button>
              </div>
              <div className='relative h-[545px]  w-[400px] flex xl:hidden flex-col items-center justify-start'>
                ...
                <input placeholder='Enter Vote ID' className='text-white absolute top-[22%] bg-[#242424] p-2 rounded-lg border-2 w-3/6 mt-[] border-white z-10'/>
                <input placeholder='Enter Candidate Name' className='text-white absolute top-[32%] bg-[#242424] p-2 rounded-lg border-2 w-3/6 mt-[] border-white z-10'/>
                <button className='absolute top-[42%] text-white  bg-[#242424] px-1 rounded-lg border-2 w-[20%] mt-[] border-white z-10'>Submit !</button>
